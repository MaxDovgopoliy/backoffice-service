...
class OrderControllerTest {
    ...
    void getAllOrdersHistory() throws Exception {
        ...
        mockMvc.perform(get("/manager/orders")
                ...
                .andExpect(jsonPath("$[0].startDate").value(orders.get(0).getStartDateTime().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))))
                .andExpect(jsonPath("$[0].endDate").value(orders.get(0).getEndDateTime().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))))
