...
class OrderServiceImplTest {
    ...
    void getOrderHistoryByUser() {
        Order expectedOrder =OrderMapper.MAPPER.toOrder(orderDtos.get(0));
    ...
    void getAllOrderHistory() {
        List<Order> expectedOrders = OrderMapper.MAPPER.toOrders(List.of(orderDtos.get(0)));
        when(orderRepo.findAllByStartDateTimeBetween(startDateTime, endDateTime)).thenReturn(
                OrderMapper.MAPPER.toOrders(
                        orderDtos));
    ...
    void getAllOrderHistoryWithoutAdditionParams() {
        List<Order> expectedOrders = OrderMapper.MAPPER.toOrders(orderDtos);
